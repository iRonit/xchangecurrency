...
public class CurrencyExchangeService {
     ...
     */
    @Cacheable
    public ExchangeRateGet getExchangeRate(@NonNull final String frmCurr, @NonNull final String toCurr)
        ...
        return ExchangeRateGet.builder()
                .fromCurrency(CurrencyGet.builder().code(frmCurr.toUpperCase())
                        .name(currenciesProperties.getCurrencies().get(frmCurr.toUpperCase())).build())
                .toCurrency(CurrencyGet.builder().code(toCurr.toUpperCase())
                        .name(currenciesProperties.getCurrencies().get(toCurr.toUpperCase())).build())
                .amount(fetchCurrentExchangeRate(frmCurr, toCurr)).lastUpdated(Date.from(Instant.now())).build();
    }
